...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Visible = True
	lb.Text = "File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ Myanmar.txj (သို့) Myanmar.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ *ေဖာင့္ေျပာင္းမည္(၂) နဲ႔ကိုနွိပ္ျပီး ထပ္သြင္းနိုင္ပါတယ္။"
End Sub

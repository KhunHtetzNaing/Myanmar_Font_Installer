...
Sub Activity_Create(FirstTime As Boolean)
	...
	lblName.Text = "Myanmar Font Installer"
	lblName.TextSize = 15
	...
	lstOne.AddSingleLine2("App Name : Myanmar Font Installer",1)
...
Sub lbname_Click
	StartActivity(p.OpenBrowser("http://www.MyanmarAndroidApp.com/search?q=Myanmar+Font+Installer"))
End Sub

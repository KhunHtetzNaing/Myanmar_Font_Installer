...
Sub Activity_Create(FirstTime As Boolean)
	...
	td.Initialize("")
	td.Text = "*ထည့္သြင္းမည္* ကိုနွိပ္ျပီး Myanmar (myFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Myanmar (myFont) ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b2_Click
	If File.Exists(File.DirRootExternal,"Myanmar.apk") = True Then
		File.Delete(File.DirRootExternal,"Myanmar.apk")
	End If
	Try
		Dim abc As Intent
		abc.Initialize("", "")

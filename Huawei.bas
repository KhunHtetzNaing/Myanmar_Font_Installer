...
Sub Activity_Create(FirstTime As Boolean)
	...
	td.Initialize("")
	td.Text = "*ထည့္သြင္းမည္* ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Myanmar Font နꩻမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ *ေဖာင့္ေျပာင္းမည္* ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Myanmar.hwt") = True Then File.Delete(File.DirRootExternal,"Myanmar.hwt")
	File.Copy(File.DirAssets,"Myanmar.hwt",File.DirRootExternal & "/HWThemes","Myanmar.hwt")

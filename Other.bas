...
Sub b1_Click
	ml.GetRoot
	If ml.HaveRoot Then
		File.Copy(File.DirAssets,"Myanmar.ttf",File.DirRootExternal,"MyanmarHeart.ttf")
...
Sub share_Click
	...
	copy.clrText
	copy.setText("#MyanmarHeartFont App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.MyanmarAndroidApp.com/search?q=Myanmar+Heart+Font")
